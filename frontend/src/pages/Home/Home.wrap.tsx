...
import { getSelectedRepositoryIds, getSelectedDevIds } from 'redux/Filters';
...
const mapStateToProps = (state: RootState) => ({
  ...
  selectedDevIds: getSelectedDevIds(state),
});
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  ...
  loadComments: (filters: { repositoryIds: number[]; devIds: string[] }) =>
    dispatch(
