...
import { PieChartAndLegendCardPropsType } from './PieChartAndLegendCard.type';
import {
  PieChartAndLegendCardWrap,
  PieChartAndTitleContainer,
  TagsLegendContainer,
} from './PieChartAndLegendCard.style';
...
export const PieChartAndLegendCard = React.memo<PieChartAndLegendCardPropsType>(props => {
